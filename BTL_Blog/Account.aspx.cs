    ...
    public partial class Account : System.Web.UI.Page
    {
            ...
            using (SqlCommand cmd = new SqlCommand("getMyInfo", con))
            {
                ...
                try
                {
                    ...
                    if (dt.Rows.Count == 1)
                    {
                        ...
                        this.txtpass.Text = dt.Rows[0]["pass"].ToString();
                    }
                    else
                    {
                        Response.Redirect("~/ErrorPage.aspx");
        ...
        protected void alter_Click(object sender, EventArgs e)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("updateInfo", con))
            {
                ...
                cmd.Parameters.AddWithValue("@pass", this.txtpassmoi.Text);
        ...
        protected void CustomValidator1_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            {
                Response.Write("<script language='javascript'>alert('mat khau bi trung');</script>");
            }
            else
            {
