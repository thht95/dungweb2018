...
<body>
                ...
                <div class="col-xs-10 col-xs-offset-1" style="min-height:1px;">
                    <div class="row" style="margin-top:30px;">
                        <div class="col-md-4" style="min-height:1px;">
                            <div class="row" style="margin-top:30px;">
                                <div class="col-xs-3" style="min-height:1px;">
                                    <img class="img-circle img-responsive slideShow"  src="/assets/img/founder/dung.jpg" alt="thumb" style="box-shadow:0px 4px 8px #888888"/>
                                </div>
                        ...
                        <div class="col-md-4" style="min-height:1px;">
                            <div class="row" style="margin-top:30px;">
                                <div class="col-xs-3" style="min-height:1px;">
                                    <img class="img-circle img-responsive slideShow" src="/assets/img/founder/thangka.png"" alt="thumb" style="box-shadow:0px 5px 9px #888888"/>
                                </div>
                                <div class="col-xs-9" style="min-height:1px;">
                                    <h4>
                                        <br />
                                ...
                                <asp:Repeater runat="server" ID="randomUser">
                                    ...
                                    <FooterTemplate>
                                        <div style="padding-left:10px;">
                                            <asp:LinkButton runat="server" ForeColor="Black" ID="myFriends" Text="Bạn bè" OnClick="myFriends_Click" Font-Underline="false"></asp:LinkButton>
                                        </div>
                                    </FooterTemplate>
                                </asp:Repeater>
                            </div>
    ...
    <footer class="container-fluid text-center slideShow" style="font-family:Arial, Helvetica, sans-serif; height:110px;">
        <p style="margin-top:30px;">Copyright © <a href="#" style="color:rgba(34, 34, 34, 0.75);text-decoration:none">Duc Thang</a>, <a href="#" style="color:rgba(34, 34, 34, 0.75);text-decoration:none">Hoang Dung</a> <a href="#" style="color:rgba(34, 34, 34, 0.75);text-decoration:none"></a></p>
